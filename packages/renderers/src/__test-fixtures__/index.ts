...
export function createMoreStats(overrides: Partial<MoreStats> = {}): MoreStats {
  return {
    ...
    modelEfficiency: {
      method:
        'Eligible models need at least 2 events, 1000 total tokens, non-zero input/output tokens, and positive cost. Score is the mean of normalized output per dollar, output/input ratio, and cache coverage.',
      rankings: [
        {
          model: 'claude-3-sonnet',
          eventCount: 3,
          ...
          cost: 0.45,
          outputInputRatio: 0.7142857142857143,
          outputPerDollar: 33333.333333333336,
          cacheCoverage: 0.19230769230769232,
          costPer1MTotal: 10.714285714285714,
          score: 0.88,
          scoreBreakdown: {
            outputPerDollar: 1,
            outputInputRatio: 0.74,
            cacheCoverage: 0.9,
          },
        },
        {
          ...
          cost: 0.24,
          outputInputRatio: 0.5777777777777777,
          outputPerDollar: 21666.666666666668,
          cacheCoverage: 0.16666666666666666,
          costPer1MTotal: 13.333333333333334,
          score: 0.54,
          scoreBreakdown: {
            outputPerDollar: 0.52,
            outputInputRatio: 0.61,
            cacheCoverage: 0.49,
          },
        },
      ],
