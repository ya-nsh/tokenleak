...
export type MetricTab = 'overview' | 'sess' | 'tok' | 'model' | 'cwd' | 'dow' | 'tod';

export const TIME_RANGES: TimeRange[] = ['7d', '30d', '90d', '365d'];
export const METRIC_TABS: MetricTab[] = ['overview', 'sess', 'tok', 'model', 'cwd', 'dow', 'tod'];
...
export function renderTabBar(
  ...
  const hints = [
    ...
    `${bold256('1-7', HINT_COLOR, noColor)} jump`,
